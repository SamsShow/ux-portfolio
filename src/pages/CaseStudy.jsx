  ...
  return (
    <div style={{ padding: m ? 16 : 32, display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ display: 'flex', flexDirection: m ? 'column' : 'row', gap: 16 }}>
        <motion.div
          {...fadeUp}
          style={{ ...card, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: m ? 24 : 40, flex: 1, height: m ? 'auto' : 440 }}
        >
          ...
          <div>
            <motion.h1
              ...
              style={{ fontFamily: "'Space Grotesk'", fontWeight: 700, fontSize: m ? 36 : 64, color: '#FFFFFF', lineHeight: m ? '42px' : '70px', letterSpacing: '-0.02em', margin: 0 }}
            >
              KitchenOS
            </motion.h1>
        ...
        {/* Meta */}
        <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.1 }} style={{ display: 'flex', flexDirection: 'column', gap: 16, width: m ? '100%' : 360, flexShrink: 0 }}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <motion.div whileHover={{ scale: 1.03 }} style={{ flex: 1, backgroundColor: '#4A9EFF', borderRadius: 14, padding: 16, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
              <span style={{ fontFamily: "'Space Grotesk'", fontWeight: 700, fontSize: m ? 24 : 28, color: '#0A0A0A' }}>40%</span>
            ...
            <motion.div whileHover={{ scale: 1.03 }} style={{ flex: 1, backgroundColor: '#1E1E1E', borderRadius: 14, padding: 16, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
              <span style={{ fontFamily: "'Space Grotesk'", fontWeight: 700, fontSize: m ? 24 : 28, color: '#FFFFFF' }}>4.8</span>
      ...
      <motion.div
        {...fadeUp}
        style={{ ...card, width: '100%', height: m ? 360 : 480, display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}
      >
          ...
          {[
            ...
            return (
              <motion.div
                ...
                style={{
                  width: i === 1 ? 240 : 220, height: m ? 300 : screen.h, backgroundColor: '#1E1E1E', borderRadius: 28,
      ...
      <div style={{ display: 'flex', flexDirection: m ? 'column' : 'row', gap: 16 }}>
        {[
          ...
          <motion.div key={section.label} {...fadeUp} style={{ ...card, flex: 1, padding: m ? 24 : 36, display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <span style={{ fontFamily: "'Space Grotesk'", fontWeight: 700, fontSize: m ? 20 : 26, color: '#FFFFFF', lineHeight: '34px' }}>{section.title}</span>
      ...
      <motion.div {...fadeUp} style={{ display: 'flex', flexDirection: 'column', gap: 16, width: '100%' }}>
        <div style={{ ...card, padding: m ? 24 : 36, display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <span style={{ fontFamily: "'Space Grotesk'", fontWeight: 700, fontSize: m ? 24 : 32, color: '#FFFFFF', lineHeight: '40px' }}>How I got there</span>
        </div>
        <div style={{ display: 'flex', flexDirection: m ? 'column' : 'row', gap: 16 }}>
          {[
      ...
      <motion.div {...fadeUp} style={{ display: 'flex', flexDirection: 'column', gap: 16, width: '100%' }}>
        <div style={{ ...card, padding: m ? 24 : 36, display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <span style={{ fontFamily: "'Space Grotesk'", fontWeight: 700, fontSize: m ? 24 : 32, color: '#FFFFFF', lineHeight: '40px' }}>The final product</span>
        </div>
        <div style={{ display: 'flex', flexDirection: m ? 'column' : 'row', gap: 16 }}>
          {[
      ...
      {/* Results */}
      <motion.div {...fadeUp} style={{ ...card, padding: m ? 24 : 36, display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <span style={{ fontFamily: "'Space Grotesk'", fontWeight: 700, fontSize: m ? 20 : 26, color: '#FFFFFF', lineHeight: '34px' }}>The numbers speak</span>
        <div style={{ display: 'flex', flexDirection: m ? 'column' : 'row', gap: 16 }}>
          {[
            ...
            <motion.div key={result.value} whileHover={{ scale: 1.02 }} style={{ flex: 1, backgroundColor: `${result.color}14`, borderRadius: 16, padding: 24, display: 'flex', flexDirection: 'column', gap: 6 }}>
              <span style={{ fontFamily: "'Space Grotesk'", fontWeight: 700, fontSize: m ? 28 : 40, color: result.color }}>{result.value}</span>
      ...
      <div style={{ display: 'flex', flexDirection: m ? 'column' : 'row', gap: 16 }}>
        <motion.div {...fadeUp} style={{ ...card, flex: 1, padding: m ? 24 : 36, display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <motion.div
          ...
          style={{ ...card, width: m ? '100%' : 400, flexShrink: 0, padding: m ? 24 : 36, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', position: 'relative' }}
        >
          ...
          <div style={{ position: 'relative' }}>
            <span style={{ fontFamily: "'Space Grotesk'", fontWeight: 700, fontSize: m ? 24 : 32, color: '#FFFFFF', lineHeight: '38px', display: 'block' }}>Framer Xplore</span>
